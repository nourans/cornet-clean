...
for filename in all_images:
    try:
        ...
        if is_correct_before == True: # if it passes cornet
        ...
        for eps in epsilons:
            ...
            try:
                save_adv_image(perturbed_image, eps, true_label, true_index, pred_before, pred_after, output_dir=f"adv_CORoutputs9/adv_outputs9_eps{eps}")
